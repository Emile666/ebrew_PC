...
\begin{tikzpicture}[>=latex]
  ...
  \node[state, name=std16,below of=std12]                                                         {16. CHILL AND PUMP TO FERMENTATION-BIN};
  ...
  \node(std_bits)[shape=rectangle,draw,below of=std09,right of=std09,xshift=20em,yshift=-10em]
  {
   ...
   leave\_pump\_on & 1     & -       & 1=Leave pumps running if MLT temp. is reached  \\
       Malt\_First & 0     & -       & 1=Malt is added to MLT first, then water       \\ \hline
  ...
  \draw ($(std00.north) + (-20em,0)$)      node[left,green]{\emph{Condition}}
        ...
        ($(std00.north) + (-20em,-3.4em)$) node[left]{\emph{r1.96, 27-07-2019}}
  ...
  \draw % To 02. Prime Pump
        (std01.south)        edge[stateEdge] 
                             node[edgeCondition, text width=24em,pos=0.18]{\emph{Temp HLT Ok  ($Thlt\ge tset\_hlt$) and\\(not Malt\_First or User selects "Malt added to MLT"))}}
  ...
  \draw % To state 19. Ready to add Malt
        ...
        (A031)               edge[stateEdge] 
                             node[edgeCondition,right,text width=16em,pos=0.15]{\emph{$(Tmlt\ge ms[ms\_idx].temp+Toffset2)$ \\and ms\_idx==0 and not Malt\_First\\and leave\_pump\_on}} 
        ...
        (std03.south)        edge[stateEdgePortion]
                             node[edgeCondition,right,text width=16em,pos=0.18]{\emph{$(Tmlt\ge ms[ms\_idx].temp+Toffset2)$ \\and ms\_idx==0 and not Malt\_First\\and not leave\_pump\_on}} 
		...
		($(std03.south) + (-2em,0)$) edge[stateEdge] 
		                             node[edgeCondition,left,text width=16em,pos=0.3]{\emph{$(Tmlt\ge ms[ms\_idx].temp+Toffset2)$ \\and (ms\_idx\textgreater0 or Malt\_First)}} 
  ...
  \draw % To itself 1
		...
		(std05.east -| std06.north)      edge[stateEdge]            
		                                 node[edgeCondition,right,pos=0.3,text width=15em]{\emph{sp\_idx\textless SP\_BATCHES\\and timer1$\ge$SP\_TIME}}       
		                                 node[edgeAction,right,pos=0.7,text width=15em]{\emph{Vmlt\_old=Vmlt\\Vboil\_old=Vboil}}
		                                 coordinate[pos=0.5] (A05N)   (std06.north)  
        ($(A05N) + (10em,0)$)            -- (A05N)
        
        % To state 09. Empty MLT
		(std05.south)                    edge[stateEdge]     
										 node[edgeCondition,right,pos=0.49,text width=15em]{\emph{sp\_idx$\ge$SP\_BATCHES\\and timer1$\ge$SP\_TIME}}
...
\begin{tikzpicture}[>=latex,
  ...
  \tikzstyle{Tsensor}= [draw, very thick, fill=cyan,  circle, minimum width=4em, align=center, font={\sffamily\bfseries\large}]
  \tikzstyle{Fsensor}= [draw, very thick, fill=green, circle, minimum width=4em, font={\sffamily\bfseries\large}]
  \tikzstyle{tekst}  = [above, font={\sffamily\Large}];

  \node[kettle, name=hlt]                             {};
  \node[kettle, name=mlt  , right of=hlt,xshift=20em] {};
  \node[kettle, name=boil , right of=mlt,xshift=15em] {};
  \node[pump  , name=pump1,below of=mlt, yshift=-24em]{}; 
  \node[pump  , name=pump2,left of=hlt, xshift=-10em,yshift=-10em]{}; 
  
  \draw % HLT, Hot-Liquid Tun
        (hlt.north)                       node[tekst,font=\sffamily\Huge] {HLT 200L}

        % Valve V2
        ($(hlt.south) + (0,-2em)$)        node[triangle,name=v2n,rotate=180]{}
        ($(v2n.south) + (0,-1.8em)$)      node[triangle,name=v2s]{}
        ($(v2n.east)  + (2.5em,-1.6em)$)  node[tekst]{\emph{V2}}
		($(v2n.west)  + (-2em,0.6em)$)    edge[black,line width=2.0pt,->] ($(v2n.west)  + (-2em,-2em)$)
		
        % Blue line out of HLT with V2 and Flow Indicator
        ($(v2n.north) + (0,4em)$)         node[fill=blue,circle,inner sep=4pt]{} %blue dot
                                          edge[blue,line width=4.0pt] (v2n.south)
        (v2s.south)                       edge[blue,line width=4.0pt] ($(v2s.south) + (0,-2em)$)
        ($(v2s.south) + (-0.2em,-2em)$)   edge[blue,line width=4.0pt] ($(v2s.south) + (6em,-2em)$)
        ($(v2s.south) + (6em,-2em)$)      node[Fsensor,name=flow1]{FI} node[tekst,below,yshift=-2em]{\emph{flow1\_hlt\_mlt}}
        ...
        ($(hltcfc1.north) + (0,-0.2em)$)  edge[red,line width=4.0pt] ($(hltcfc1.north) + (10em,-0.2em)$)

        % Valve V4
		($(hltcfc1.north) + (10em,-0.2em)$) node[triangle,name=v4n,rotate=-90]{}
		($(v4n.north) + (0.2em,-0.0em)$)    node[triangle,name=v4s,rotate=+90]{}
		($(v4n.east)  + (0.6em,-2.0em)$)    node[tekst]{\emph{V4}}
		($(v4n.north)  + (-1.7em,1.5em)$)   edge[black,line width=2.0pt,->] ($(v4n.north)  + (+1.2em,1.5em)$)
        (v4s.south)                         edge[red,line width=4.0pt] coordinate[pos=1.0] (V4CONNECT) ($(v4s.south) + (3em,0.0em)$) 
        
	    % Temperature Indicator
	    (hlt.center)                      node[Tsensor,name=Thlt]{TI}
        ($(Thlt.east)  + (1.6em,-0.9em)$) node[tekst]{\emph{Thlt}} 
        ;
  ...
  \draw % MLT, Mash-Lauter Tun
        ...
        % Valve V1
		($(mlt.south) + (0,-2em)$)        node[triangle,name=v1n,rotate=180]{}
		($(v1n.south) + (0,-1.8em)$)      node[triangle,name=v1s]{}
		($(v1n.east)  + (2.5em,-1.6em)$)  node[tekst]{\emph{V1}}
		($(v1n.west)  + (-2em,0.6em)$)    edge[black,line width=2.0pt,->] ($(v1n.west)  + (-2em,-2em)$)
        ...
        ($(mlt1.west) + (0.2em,0)$)       edge[red,line width=4.0pt]           ($(mlt1.west) + (0.2em,2em)$)
        ($(mlt1.west) + (0.4em,2em)$)     edge[red,line width=4.0pt]           ($(V4CONNECT |- mlt1.west) + (-0.4em,2em)$)
        ($(V4CONNECT |- mlt1.west) + (-0.2em,2em)$) edge[red,line width=4.0pt] ($(V4CONNECT) + (0,-0.2em)$)
        ...
        ($(mlt2.south) + (0,0.4em)$)      edge[blue,line width=4.0pt] (v1n.south)
		(v1s.south)                       edge[blue,line width=4.0pt] ($(v1s.south |- flow1.east) + (0,-0.2em)$)
        ($(v1s.south |- flow1.east) + (-0.0em,0.0em)$) edge[blue,line width=4.0pt] (flow1.east)
        
	    % Temperature Indicator
	    (mlt.center)                      node[Tsensor,name=Tmlt]{TI}
        ($(Tmlt.east)  + (1.6em,-0.9em)$) node[tekst]{\emph{Tmlt}}
        ;
        
  \draw % Boil-Kettle
        (boil.north) node[tekst,font=\sffamily\Huge] {BOIL 140L} 
	    
        % Valve V3
		($(boil.south) + (0,-2em)$)       node[triangle,name=v3n,rotate=180]{}
		($(v3n.south)  + (0,-1.8em)$)     node[triangle,name=v3s]{}
		($(v3n.east)   + (2.5em,-1.6em)$) node[tekst]{\emph{V3}}
		($(v3n.west)   + (-2em,0.6em)$)   edge[black,line width=2.0pt,->] ($(v3n.west)  + (-2em,-2em)$)

        % Manifold in bottom of MLT
		($(boil.south) + (0,1.5em)$)      node[cfc1,blue,line width=4.0pt,name=boil1]{}
										  node[tekst,yshift=1em]{\emph{False Bottom}}
		($(boil1.south) + (0,0.2em)$)     node[fill=blue,circle,inner sep=4pt]{} % blue dot
		($(boil1.south) + (0,0.4em)$)     edge[blue,line width=4.0pt] (v3n.south)
		
	    % Temperature Indicator
	    (boil.center)                     node[Tsensor,name=Tboil]{TI}
        ($(Tboil.east) + (1.6em,-0.9em)$) node[tekst]{\emph{Tboil}}
        
        % Valve V7
        ($(v3n.east)   + (6.5em,0)$)      node[triangle,name=v7n,rotate=180]{}
        ($(v7n.south)  + (0,-1.8em)$)     node[triangle,name=v7s]{}
        ($(v7n.east)   + (2.5em,-1.6em)$) node[tekst]{\emph{V7}}
        ($(v7n.west)   + (-2em,0.6em)$)   edge[black,line width=2.0pt,<-] ($(v7n.west)  + (-2em,-2em)$)
        (v7n.south)                       edge[red,line width=4.0pt,->] ($(v7n.north) + (0,7em)$)
        ;
  ...
  \draw % Pump1
		...
		($(pump1.north |- flow1.east) + (-3em,0em)$) edge[blue,line width=4.0pt,->] ($(pump1.north) + (-3em,0.8em)$)
		...
		% Blue connecting line from V3 to Pump
		(v3s.south)                       			 edge[blue,line width=4.0pt] (v3s.south |- flow1.east)
		($(v3s.south |- flow1.east) + (0.2em,0)$)    edge[blue,line width=4.0pt] ($(v1s.south |- flow1.east) + (0.2em,0)$)

        % Pump 2 (HLT)
        (pump2.south) node[tekst,yshift=-0.2em,font=\sffamily\Huge] {Pump} 
		($(pump2.north) + (-2.3em,0.5em)$)           node[fill=cyan,circle,inner sep=4pt]{} % cyan dot
													 node[tekst,below,yshift=-0.5em]{\emph{OUT}} 
		($(pump2.north) + (-2.3em,0.5em)$)           edge[cyan,line width=4.0pt] ($(pump2.north) + (-2.3em,3em)$)
		($(pump2.north) + (-2.5em,3em)$)             edge[cyan,line width=4.0pt,->] ($(pump2.north) + (+8.5em,3em)$)
		($(pump2.north) + (+3.0em,0.5em)$)           node[fill=cyan,circle,inner sep=4pt]{}  % cyan dot
													 node[tekst,below,xshift=-0.3em,yshift=-0.5em]{\emph{IN}}
		($(pump2.north) + (+3.0em,0.5em)$)			 edge[cyan,line width=4.0pt] ($(pump2.north) + (+3.0em,2.0em)$)
		($(pump2.north) + (+2.8em,2.0em)$)			 edge[cyan,line width=4.0pt] ($(pump2.north) + (+6.5em,2em)$)
		($(pump2.north) + (+6.3em,2em)$)			 edge[cyan,line width=4.0pt] ($(pump2.north) + (+6.3em,-2em)$)
		($(pump2.south) + (0,-2em)$)			     node[tekst]{\emph{Iwaki MD-30RZ}}
		;

  \draw % Counter-flow Chiller (CFC)
  		($(pump1.east) + (10em,2em)$)                node[cfc1,line width=4.0pt,name=cfc2n]{}
  		($(pump1.east) + (10em,1.1em)$)              node[cfc1,line width=4.0pt]{}
  		($(pump1.east) + (10em,0.2em)$)              node[cfc1,line width=4.0pt]{}
  		($(pump1.east) + (10em,-0.7em)$)             node[cfc1,line width=4.0pt,name=cfc2s]{}
  		
  		($(cfc2s.east) + (-0.2em,0)$)  			     edge[red,line width=4.0pt] ($(cfc2s.east) + (-0.2em,-2em)$)

  		% Temperature Indicator
  		($(cfc2s.east) + (-0.2em,-4em)$)			 node[Tsensor,name=Tcfc]{TI}
  		($(Tcfc.east) + (1.6em,-0.9em)$) 			 node[tekst]{\emph{Tcfc}}

  		% Flow Indicator for CFC
  		(Tcfc.south)                                 edge[red,line width=4.0pt] ($(Tcfc.south) + (0,-4em)$)
  		($(Tcfc.south) + (0,-4em)$)					 node[Fsensor,name=flow3]{FI} node[tekst,right,xshift=2em]{\emph{flow3\_cfc}}
  		(flow3.south)                                edge[red,line width=4.0pt,->] ($(flow3.south) + (0,-3em)$)
  		($(flow3.south) + (0,-4.5em)$)               node[tekst]{\emph{To Fermentation Vessel}}

  		% Valve V6
		($(cfc2n.west) + (+0.2em,+4em)$)             node[triangle,name=v6n,rotate=180]{}
		($(v6n.south)  + (0,-1.8em)$)     			 node[triangle,name=v6s]{}
		($(v6n.east)   + (2.5em,-1.6em)$) 			 node[tekst]{\emph{V6}}
		($(v6n.west)   + (-2em,0.6em)$)   			 edge[black,line width=2.0pt,->] ($(v6n.west)  + (-2em,-2em)$)
		
  		% Flow Indicator for V7, Boil input
		($(v6n.south -| v3n.south)  + (2.5em,1em)$)  node[Fsensor,name=flow2]{FI} node[tekst,below,yshift=-2em]{\emph{flow2\_mlt\_boil}}

		% Connect CFC to V6
		($(cfc2n.west) + (+0.2em,0)$)                edge[red,line width=4.0pt] (v6s.south)

		% Connect V6 to Flowmeter 2 and to V7
		(v6n.south)                                  edge[red,line width=4.0pt] ($(v6n.south)  + (0,1em)$)
		($(v6n.south)  + (0,1em)$)                   edge[red,line width=4.0pt] (flow2.west)
		(flow2.east)                    			 edge[red,line width=4.0pt] ($(flow2.east -| v7s.north) + (0.2em,0)$)
		(flow2.east -| v7s.north)	 				 edge[red,line width=4.0pt] (v7s.south)

		% Connect V6 to HLT-CFC
		($(v6n.south)  + (0,1em)$)					 edge[red,line width=4.0pt] ($(v6n.south     -| V4CONNECT)  + (-0.2em,1em)$)
		($(v6n.south -| V4CONNECT)  + (0em,1em)$)    edge[red,line width=4.0pt] ($(hltcfc2.south -| V4CONNECT)  + (0,0.4em)$)
		($(hltcfc2.south -| V4CONNECT) + (0,0.2em)$) edge[red,line width=4.0pt] ($(hltcfc2.south)  + (0,0.2em)$)

		% Connect Pump out to red lines
		($(pump1.north) + (+2.5em,0.5em)$)           edge[red,line width=4.0pt,->] ($(pump1.north |- v6n.south) + (2.5em,1.2em)$)
		
		% Manual bypass valve
		($(pump1.west) + (-5em,4em)$)        		 node[triangle,name=vbyn,rotate=-90]{}
		($(vbyn.north) + (0.2em,-0.0em)$)    		 node[triangle,name=vbys,rotate=+90]{}
		($(vbyn.east)  + (1.5em,-4.0em)$)    		 node[tekst,text width=10em]{\emph{Vx Manual\\Bypass Valve}}
		($(vbyn.north) + (-1.7em,1.5em)$)   		 edge[black,line width=2.0pt,->] ($(vbyn.north)  + (+1.2em,1.5em)$)
		(vbyn.south)				               	 edge[red,line width=4.0pt]      ($(vbyn.south)  + (-2em,0)$)
		($(vbyn.south)  + (-1.8em,0)$)				 edge[red,line width=4.0pt]      ($(vbyn.south |- v6n.south)  + (-1.8em,1em)$)
		(vbys.south)				               	 edge[blue,line width=4.0pt]     ($(vbys.south)  + (2.2em,0)$)
		($(vbys.south)  + (2em,0)$)				 	 edge[blue,line width=4.0pt]     ($(vbys.south |- flow1.east)  + (2em,0)$)

		% Manual drain valve
		($(v6n.south -| V4CONNECT)  + (0em,1em)$)	 edge[red,line width=4.0pt]     ($(v6n.south -| V4CONNECT)  + (0em,-10em)$)
		($(v6n.south -| V4CONNECT)  + (0em,-10em)$)	 node[triangle,name=vmn,rotate=180]{}
		($(vmn.south)  + (0,-1.8em)$)     			 node[triangle,name=vms]{}
		($(vmn.east)   + (6.5em,-2.4em)$) 			 node[tekst,text width=10em]{\emph{Vy Manual\\Drain Valve}}
		($(vmn.west)   + (-2em,0.6em)$)   			 edge[black,line width=2.0pt,->] ($(vmn.west)  + (-2em,-2em)$)
		(vms.south)				               	 	 edge[red,line width=4.0pt]     ($(vms.south)  + (0,-2em)$)
  		;
  				
  \draw % Legend
  		($(hlt.south) + (-12em,-15em)$)   node[Tsensor,name=TI]{TI}
  		($(TI.east)  + (13em,-2.0em)$)    node[tekst,text width=25em,align=left]{\emph{Temperature Indicator\\LM92 ($I^2C$) or DS18B20 (One-Wire)}}
	    ($(TI.south) + (0,-4em)$)         node[Fsensor,name=FI]{FI}
 	    ($(FI.east)  + (13em,-1.5em)$)    node[tekst,text width=25em,align=left]{\emph{Flow Indicator\\FS300A water flow sensor}}
	    ($(FI.south) + (0,-2.5em)$)       node[triangle,name=vxn,rotate=180]{}
	    ($(vxn.south) + (0,-1.8em)$)      node[triangle]{}
	    ($(vxn.east)  + (15.5em,-2.5em)$) node[tekst,text width=25em,align=left]{\emph{Solenoid Ball Valve\\Ehcotech M21SE-1/2-E3BW}}
        ;
\end{tikzpicture}
